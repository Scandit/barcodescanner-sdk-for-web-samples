sap.ui.define([
	...
	return Opa5.extend("ns.testproject.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ns/testproject/localService/mockserver"], function (mockserver) {
