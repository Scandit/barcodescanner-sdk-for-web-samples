		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Scandit Web SDK integration",
									"targetURL": "#ScanditWebSDKintegration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ScanditWebSDKintegration-display": {
								"semanticObject": "ScanditWebSDKintegration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.testproject",
									"url": sap.ui.require.toUrl("ns/testproject")
								}
							}
						}
					}
